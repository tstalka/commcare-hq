...
from corehq.motech.repeaters.views.repeaters import AddDhis2RepeaterView, AddDhis2EntityRepeaterView
...
urlpatterns = [
    ...
    url(
        r'^new_dhis2_entity_repeater$',
        AddDhis2EntityRepeaterView.as_view(),
        {'repeater_type': 'Dhis2EntityRepeater'},
        name=AddDhis2EntityRepeaterView.urlname
    ),
    url(
